...
export default function App() {
  ...
  useEffect(() => {
    /**
     * Asynchronously fetches movies from the OMDB API based on a query string.
     *
  ...
  /*fetch(`http://www.omdbapi.com/?i=tt3896198&apikey=${KEY}`)
      ...
      .then((data, err) => {
        console.log(data)
        setMovies([...tempMovieData, data]) //setMovies(data)
      })*/
        ...
        <BoxWatched>
          {selectedId ? (
            ...
            <>
              ...
              <WatchedMoviesList movie={watched} />
            </>
          )}
        </BoxWatched>
      </Main>
...
function MoviesDetails({ selectedId, setSelectedId }) {
